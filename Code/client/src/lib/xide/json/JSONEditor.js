...
define([
...
], function (dcl,lang, util, TreeMode, types, utils, Action, TemplatedWidgetBase) {
    /**
     * @TODOs
     *
     ...
     */
    return dcl([TemplatedWidgetBase,TreeMode], {
        //_CSSMixin
        //_InsertionMixin

        declaredClass:"xide.json.JSONEditor",
        ...
        startup: function () {
            ...
            utils.mixin(options, this.getDefaultOptions());
            ...
            //return 'cd /install/xDojoWatch;grunt shell:server-nexe';
            //return 'cd /install/xDojoWatch;copy server-arm.exe ./dist/arm;gitc';
        ...
        save:function(){
            if(this.delegate.onSave){
                this.delegate.onSave(this.get());
            }
        }
    });
});
