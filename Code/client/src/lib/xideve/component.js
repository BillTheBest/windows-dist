    ...
    return declare('xideve/component',[Component], {
        ...
        registerEditors:function(){
            ...
            if(has('delite')){
                ...
                var BASE_URL = dojo.baseUrl;
                var IBM_ROOT = 'xibm/ibm/';
                var template = deliteTemplate.create(BASE_URL,BASE_URL + IBM_ROOT,BASE_URL,'bootstrap');
                //temp.
                ...
                templateInstance = new templateClass({
                    ...
                    templateVariables:{
                        ...
                        lodashUrl:dojo.baseUrl + 'external/lodash.min.js'
                    },
                    bodyStyle:{
                        width:"100%",
                        height:"100%",
